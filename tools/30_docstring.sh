...
# Check if generated files have been modified directly (basic validation)
check_generated_files() {
	local generated_files=("./docs/index.html")
	local warnings=0
	
	for file in "${generated_files[@]}"; do
		if [[ -f "$file" ]]; then
			# Check if file contains auto-generated header
			if ! grep -q "AUTO-GENERATED FILE - DO NOT EDIT DIRECTLY" "$file"; then
				echo "WARNING: $file appears to be missing auto-generated header!"
				echo "This file should be generated, not edited directly."
				((warnings++))
			fi
		fi
	done
	...
	if [[ $warnings -gt 0 ]]; then
		echo "Found $warnings potential issues with generated files."
		echo "Please ensure you edit source files and run this script to regenerate."
		echo
	fi
}

# Add auto-generated header to HTML files
add_autogenerated_header() {
	local source_file="$1"
	local dest_file="$2"
	local source_relative_path="$3"
	
	# Create the auto-generated header
	cat > "$dest_file" << EOF
<!--
================================================================================
...
This file is automatically generated from: $source_relative_path

To make changes:
1. Edit the source file: $source_relative_path
2. Run: ./tools/30_docstring.sh
3. This will regenerate: $dest_file
...
main() {
	case "$1" in
		...
		""|*)
			...
			add_autogenerated_header "./tools/uxgo/index.html" "./docs/index.html" "tools/uxgo/index.html"
			echo "Generated docs/index.html with auto-generated header"
