...
web_docs(){
	case "${1:-}" in
		...
		*)
			...
			#cp "$ROOT_DIR/workflow/index.html" "$ROOT_DIR/modules_browsers/modules_browser.html"
			...
			_add_auto_generated_warning "$ROOT_DIR/modules_browsers/modules_browser.html" "workflow/index.html" "This file is a direct copy of the source template."
			echo "done"
			;;
	esac
}
